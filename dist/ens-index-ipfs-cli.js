...
program2.command("start").description("Start running the background service").action(() => {
  console.log("Background service started.");
});
program2.command("stop").description("Stop running the background service").action(() => {
