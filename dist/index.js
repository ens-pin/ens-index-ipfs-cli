...
program2.name("ens-index-ipfs-cli").description("A CLI tool for interacting with ENS and IPFS").version("1.0.0");
program2.command("greet").description("Print a greeting message").argument("<name>", "Name to greet").action((name) => {
